...
class TatarusAi(context: Context) : GameOpponent {
    ...
    private val modelFile =
        File(context.applicationContext.filesDir, MODEL_FILE)
    ...
    override fun reset() {
        ...
        decisionNanos = 0L
        modelFile.delete()
        File(modelFile.parentFile, MODEL_TEMP_FILE).delete()
    }
    ...
    private fun save() {
        ...
        val temporaryFile = File(modelFile.parentFile, MODEL_TEMP_FILE)
    ...
    companion object {
        ...
        private const val MODEL_TEMP_FILE = "tatarus_large_v1.tmp"
